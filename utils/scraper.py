...
import time
"""
The following code is a web scraper that downloads zip files from the National Science Foundation (NSF) website.
And later unzips the files and stores the contents in a specified directory.
"""
